...
class OfflineFormRepository (private val formDao: FormDao) : FormRepository {
    ...
    override fun getUserByName(name: String): Flow<UserEntity?> = formDao.getUserByName(name)

    override fun getAllAccountsByName(name: String): Flow<List<UserEntity>> = formDao.getAllAccountsByName(name)
    override fun getUserByEmail(email: String): Flow<UserEntity?> = formDao.getUserByEmail(email)
    override fun getAllAccountsByEmail(email: String): Flow<List<UserEntity>> = getAllAccountsByEmail(email)
    */
    //Clima
